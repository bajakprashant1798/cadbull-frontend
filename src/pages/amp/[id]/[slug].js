  ...
  return (
    <>
      <Head>
        ...
        {/* Custom styles - Remove !important if present */}
        {/* 
              ...
              <div className="card-wrapper mbr-flex mbr-column mbr-pt-3 mbr-pb-3 mbr-px-4">
                <div className="card-img align-center mbr-pb-3">
                  <div class="iconfont-wrapper">
                    <span class="amp-iconfont mbri-file"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 32 32" fill="currentColor">
            ...
            <div className="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-3 align-center md-pb">
              <div className="card-wrapper mbr-flex mbr-column mbr-pt-3 mbr-pb-3 mbr-px-4">
                <div className="card-img align-center mbr-pb-3">
                  {/* SVG icon */}
                  <div class="iconfont-wrapper">
                    <span class="amp-iconfont mbri-folder"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 32 32" fill="currentColor">
            ...
            <div className="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-3 align-center last-child">
              <div className="card-wrapper mbr-flex mbr-column mbr-pt-3 mbr-pb-3 mbr-px-4">
                <div className="card-img align-center mbr-pb-3">
                  {/* SVG icon */}
                  <div class="iconfont-wrapper">
                    <span class="amp-iconfont mbri-add-submenu"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 32 32" fill="currentColor">
              ...
              <div className="card-wrapper">
                <div className="card-img mbr-m-auto">
                  <amp-img
                    ...
                    width="387"
                    height="387"
                    alt={publisher ? `${publisher.firstname} ${publisher.lastname}` : "Publisher"}
                  />
                </div>
          ...
          <div className="mbr-row align-center mbr-jc-c">
            ...
            <div className="mbr-section-btn">
              <a className="btn btn-warning">
                <span className="mobi-mbri-cash"></span>
                {product.type || ""} File
              </a>
              <a
              ...
              >
                <span className="mobi-mbri-download"></span>
                Download Now
              </a>
            </div>
          </div>
