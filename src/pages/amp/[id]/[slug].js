...
export default function AmpProductPage({ product, similar, publisher, categoryName, subcategoryName, user }) {
  ...
  return (
    <>
      ...
      <style jsx global>{`
        /* ---- START: your combined CSS ---- */
        body{font-family:'Poppins',system-ui,arial,sans-serif;margin:0;padding:0}
        ...
        /* ⬇️ also paste the long CSS that you currently put inside <style amp-custom> in the AMP page */
        /* ... ALL other styles from amp/[id]/[slug].js ... */
