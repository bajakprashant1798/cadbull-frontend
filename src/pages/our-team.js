...
// Scoped Custom Styles for Our Team page
const customStyles = `
.our-team-root {
...
const OurTeamPage = () => {
  const pageUrl = `${process.env.NEXT_PUBLIC_FRONT_URL || "https://cadbull.com"}/our-team`;
  ...
  return (
    <Fragment>
      <Head>
        <title>Our Team & Technical Experts | Cadbull — CAD & Design Review Team</title>
        ...
        />
        <meta property="og:title" content="Our Team & Technical Experts | Cadbull — CAD & Design Review Team" />
        <meta
        ...
        <meta name="twitter:title" content="Our Team & Technical Experts | Cadbull" />
        <meta
      ...
      <div className="our-team-root pb-5">
        {/* HERO SECTION */}
        <section className="hero-team-bg pt-5 pb-5">
            ...
            <div className="row justify-content-center text-center">
              <div className="col-lg-10 col-xl-8">
                ...
                <p className="lead text-secondary mb-4 mx-auto" style={{ maxWidth: '780px', fontSize: '1.1rem', lineHeight: '1.75' }}>
                  Behind Cadbull’s library of over 270,000 architectural drawings, 3D models, and engineering schematics is a dedicated team of specialized architects, engineers, and CAD professionals. Our team designs original library assets and reviews every community upload to guarantee technical precision, layer organization, and project readiness.
                </p>
              ...
              <div className="row align-items-center g-4">
                <div className="col-lg-8">
                  ...
                  <p className="text-light opacity-90 mb-0" style={{ fontSize: '1rem', lineHeight: '1.7' }}>
                    Every single file submitted by our global community of 2.5M+ designers passes through our team review pipeline. Our engineers and drafters verify layering structure, dimension accuracy, scale ratios, and file compatibility before releasing files for download.
                  </p>
                </div>
            ...
            <div className="p-4 p-md-5 rounded-4 bg-white border text-center shadow-sm">
              <div className="mx-auto" style={{ maxWidth: '650px' }}>
                <h3 className="h2 fw-bold text-dark mb-3">
                  Explore Designs Curated by Our Team
                </h3>
...
OurTeamPage.getLayout = function getLayout(page) {
