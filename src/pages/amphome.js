  ...
  return (
    <html amp="" lang="en">
      ...
      <body>
        ...
        {/* AMP Sidebar */}
        <amp-sidebar id="sidebar" layout="nodisplay" side="right" className="cid-r1Dtil7YY5 i-amphtml-element i-amphtml-layout-nodisplay i-amphtml-overlay i-amphtml-scrollable i-amphtml-built">
          <div className="builder-sidebar">
            ...
            <ul className="navbar-nav nav-dropdown nav-right">
              <li className="nav-item">
                <a href="/amphome" className="nav-link mbr-bold link text-black display-7">Home</a>
              </li>
              {/* <li className="nav-item">
              ...
              {user ? (
                <>
                  <li className="nav-item"><a href="/profile/edit" className="nav-link mbr-bold link text-black display-7">{user.firstname}</a></li>
                  <li className="nav-item"><a href="/logout" className="nav-link mbr-bold link text-black display-7">Logout</a></li>
                </>
              ) : (
                <li className="nav-item"><a href="/login" className="nav-link mbr-bold link text-black display-7">Login</a></li>
              )}
        ...
        {/* Navbar/Header */}
        <section className="menu1 menu horizontal-menu cid-r1Dtil7YY5" id="menu1-d">
          <nav className="navbar navbar-dropdown navbar-expand-lg navbar-fixed-top">
            <div className="menu-container container">
              ...
              <div className="collapse navbar-collapse">
                <ul className="navbar-nav nav-dropdown nav-right">
                  <li className="nav-item">
                    <a href="/" className="nav-link mbr-bold link text-black display-7">Home</a>
                  </li>
                  {/* <li className="nav-item">
                    <a href="https://cadbull.com/features">Features</a>
                  </li>
                  ...
                  {user ? (
                    <>
                      <li><a href="/profile/edit" className="nav-link mbr-bold link text-black display-7">{user.firstname}</a></li>
